    ...
    return {
      ...
      contents: [{
        id: "info", label: b.info, title: b.info, elements: [{
          ...
          //   dialog.getContentElement('info', 'linkType').disable();
          // }
        },
          {
            id: "linkType",
            ...
            "default": "url",
            onChange: function () {
              var a = this.getDialog(), b = ["urlOptions"],
              ...
              type: "hbox", children: [
                ...
                // },
                {
                  type: "text", id: "url", label: g.url, required: !0, onLoad: function () {
                    ...
                    return a.getContentElement("info", "linkType") && true ? !0 : !c.config.linkJavaScriptLinksAllowed && /javascript\:/.test(this.getValue()) ? (alert(g.invalidValue), !1) : this.getDialog().fakeObj ? !0 : CKEDITOR.dialog.validate.notEmpty(b.noUrl).apply(this)
                  }, setup: function (a) {
          ...
          //         "default": "", label: b.anchorId, style: "width: 100%;", items: [[""]], setup: function (a) {
          //           this.clear();
          //           this.add("");
      ...
      onShow: function () {
        ...
        this.setupContent(b);
        this.getContentElement('info', 'linkType').disable();
      },
      onOk: function () {
        var a = {};
        ...
        if (this._.selectedElements.length) {
          a.url.protocol = '';
          var b = this._.selectedElements, g = n.getLinkAttributes(c, a), f = [], h, d, l, e, k;
      ...
      onFocus: function () {
        var a = "url";
        a && true && (a = this.getContentElement("info", "url"), a.select())
      }
    }
  })
})();
