  ...
  function listStyle(editor, startupPage) {
    ...
    if (startupPage == 'bulletedListStyle') {
      ...
      var listStyleOptions = [
        ...
        ['Lower Alphabetical (a, b, c, d, e, etc.)', 'lower-alpha'],
        ['Upper Alphabetical (A, B, C, D, E, etc.)', 'upper-alpha'],
        ...
        contents: [{
          ...
          elements: [{
            ...
            },
            {
              ...
              id: 'font-size',
              setup: function (element) {
                var value = element.getStyle('font-size') || element.getAttribute('font-size') || 10;
                this.setValue(value);
              },
              commit: function (element) {
                var value = this.getValue();
                if (value)
                  element.setStyle('font-size', value + 'px');
                else
