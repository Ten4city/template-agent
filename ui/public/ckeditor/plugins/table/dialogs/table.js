    ...
    return {
      title: a.lang.table.title, minWidth: 310, minHeight: CKEDITOR.env.ie ?
        ...
        var e = a.getSelection(), d = this._.selectedElement && e.createBookmarks(),
         ...
         b.setStyle("border-collapse", 'collapse');
        ...
        id: "info", label: a.lang.table.title, elements: [{
          type: "hbox", widths: ['50%', '50%'], styles: ["vertical-align:top"], children: [{
            type: "vbox", padding: 0, children: [{
              type: "text", id: "txtRows", "default": 3, label: 'Number of Rows(required)',
              required: !0, style: "width:80%", validate: r(a.lang.table.invalidRows), setup: function (e) {
              ...
              id: "txtCols",
              "default": 2,
              label: 'Number of Columns(required)',
              style: "width:80%",
              required: !0,
