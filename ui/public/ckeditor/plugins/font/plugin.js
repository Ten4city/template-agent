 ...
 */
CKEDITOR.config.font_names = 'Arial/font-arial;' +
  'Apercu Light/font-apercu-light;' +
  'Caveat/font-caveat;' +
  'Comic Sans MS/font-comic-sans-ms-new;' +
  'Courier New/font-courier-new-new;' +
  'Comfortaa/font-comfortaa;' +
  'EB Garamond/font-ebgaramond;' +
  'Georgia/font-georgia-new;' +
  'Indie Flower/font-indie-flower;' +
  'Lato/font-lato;' +
  'Lobster/font-lobster;' +
  'Lora/font-lora;' +
  'Lucida Sans Unicode/font-lucida-sans-unicode-new;' +
  'Merriweather/font-merriweather;' +
  'Montserrat/font-montserrat;' +
  'Mulish/font-mulish-new;' +
  'Nunito/font-nunito;' +
  ...
  'Tahoma/font-tahoma-new;' +
  'Times New Roman/font-times-new-roman-new;' +
  'Trebuchet MS/font-trebuchet-ms-new;' +
  'Verdana/font-verdana-new;' +
  'Garamond Regular/font-garamond-regular-new;' +
  'বাংলা(Bengali)/font-bengali-regular;' +
  'देवनागरी(Devanagari)/font-devanagari-regular;' +
  'ગુજરાતી(Gujarati)/font-gujarati-regular;' +
  'ਗੁਰਮੁਖੀ(Gurmukhi)/font-gurmukhi-regular;' +
  'ଓଡିଆ(Odia)/font-oriya-regular;' +
  'ಕನ್ನಡ(Kannada)/font-kannada-regular;' +
  'मराठी(Marathi)/font-marathi-bold;' +
  'മലയാളം(Malayalam)/font-malayalam-regular;' +
  'தமிழ்(Tamil)/font-tamil-regular;' +
  'తెలుగు(Telugu)/font-telugu-regular;'+
  'অসমীয়া(Assamese)/font-assamese-regular;' +
  'मैथिली(Maithili)/font-maithili-regular;' +
  'کٲشُر(Kashmiri)/font-kashmiri-regular;' +
  'اردو(Urdu)/font-urdu-regular;' +
  'سنڌي(Sindhi)/font-sindhi-regular;' ;
