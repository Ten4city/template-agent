...

      {
        ...
        children: (function () {
          var children = [{
            ...
            'default': '',
            setup: setupCells(function (element) {
              var borderColorAttr = element.getAttribute('leegality-border-colour'),
            ...
            commit: function (selectedCell) {
              ...
              if (this.getDialog().getContentElement('info', 'border-bottom').getValue()) {
                if (value) {
                  selectedCell.setStyle('border-bottom', '1px solid ' + this.getValue());
                } else {
                  selectedCell.removeStyle('border-bottom');
                }
              }
              if (this.getDialog().getContentElement('info', 'border-top').getValue()) {
                if (value) {
                  selectedCell.setStyle('border-top', '1px solid ' + this.getValue());
                } else {
                  selectedCell.removeStyle('border-top');
                }
              }
              if (this.getDialog().getContentElement('info', 'border-left').getValue()) {
                if (value) {
                  selectedCell.setStyle('border-left', '1px solid ' + this.getValue());
                } else {
                  selectedCell.removeStyle('border-left');
                }
              }
              if (this.getDialog().getContentElement('info', 'border-right').getValue()) {
                if (value) {
                  selectedCell.setStyle('border-right', '1px solid ' + this.getValue());
                } else {
                  selectedCell.removeStyle('border-right');
                }
              }
              selectedCell.setAttribute('leegality-border-colour', this.getValue())
        ...
        children: [
          {
            ...
            label: 'bottom',
            setup: setupCells(function (selectedCell) {
              return selectedCell.getStyle('border-bottom');
            }),
          ...
          },
          {
            ...
            label: 'top',
            setup: setupCells(function (selectedCell) {
              return selectedCell.getStyle('border-top');
            }),
          },
          {
            type: 'checkbox',
            ...
            label: 'left',
            setup: setupCells(function (selectedCell) {
              return selectedCell.getStyle('border-left');
            }),
          },
          {
            type: 'checkbox',
            ...
            label: 'right',
            setup: setupCells(function (selectedCell) {
              return selectedCell.getStyle('border-right');
            }),
          }
